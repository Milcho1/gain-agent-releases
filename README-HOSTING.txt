G.A.I.N Agent 0.4.48 hosted download files
...
GitHub Release assets for gain-agent-v0.4.48:
  gain-agent-0.4.48.tgz
  gain-agent-0.4.48-win-x64.exe
  gain-agent-0.4.48-macos-x64
  gain-agent-0.4.48-macos-arm64
  gain-agent-0.4.48-linux-x64
  gain-agent-0.4.48-linux-arm64
...
GitHub Release tarball:
  npm install -g https://github.com/Milcho1/gain-agent-releases/releases/download/gain-agent-v0.4.48/gain-agent-0.4.48.tgz
