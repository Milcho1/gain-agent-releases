G.A.I.N Agent 0.4.47 hosted download files
...
GitHub Release assets for gain-agent-v0.4.47:
  gain-agent-0.4.47.tgz
  gain-agent-0.4.47-win-x64.exe
  gain-agent-0.4.47-macos-x64
  gain-agent-0.4.47-macos-arm64
  gain-agent-0.4.47-linux-x64
  gain-agent-0.4.47-linux-arm64
...
GitHub Release tarball:
  npm install -g https://github.com/Milcho1/gain-agent-releases/releases/download/gain-agent-v0.4.47/gain-agent-0.4.47.tgz
